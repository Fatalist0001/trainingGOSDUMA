#!/usr/bin/env python
"""Run KNN model for all experiments."""
...
def main():
    parser = argparse.ArgumentParser(description="Run KNN model")
    ...
    tracker = create_tracker(f"knn_{args.experiment}")

    print(f"Running KNN model on Experiment {args.experiment}")
    ...
    save_results(results, f"knn_{args.experiment}_{args.feature_group}")
