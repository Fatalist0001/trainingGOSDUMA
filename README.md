...
6. **Реальные доли, без нормализации** — все модели предсказывают фактическую долю каждой партии (в сумме ~78%: остальное — партии вне датасета), нормировка к 100% не применяется.
...
Разрыв между партиями у лучших моделей умеренный (ЕР 7–8, КПРФ ~5.5–6, ЛДПР ~4–5): деревья предсказывают ЕР так же, как и бейзлайны.
