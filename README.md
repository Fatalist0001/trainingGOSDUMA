...
- **Прогноз на 2026 (по лучшей модели бенчмарка — WeightedHistoricalMean; федеральный итог взвешен по valid-голосам 2021 как прокси для 2026):**
  - «Единая Россия» ≈ 52.8%, КПРФ ≈ 16.1%, ЛДПР ≈ 10.4% — прогнозируемые доли голосов по федеральному партийномy списку; без нормировки. В сумме ≈79%, остальные ≈21% приходятся на партии, которые не моделируются. (⚠️ Это прогноз только результатов голосования по федеральным партийным спискам, а не прогноз распределения 450 депутатских мест. Одномандатные округа в модели не учитываются.)
